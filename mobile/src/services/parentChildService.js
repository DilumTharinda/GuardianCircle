...
const STORAGE_KEYS = {
  CHILDREN: '@guardiancircle_mock_children_v2',
  HISTORY: '@guardiancircle_mock_history_v2',
  PETS_ITEMS: '@guardiancircle_mock_pets_items_v2',
};
...
const INITIAL_MOCK_CHILDREN = [
  {
    ...
    targetUid: 'child_uid_leo',
    targetName: 'Leo Anderson',
    targetAge: 9,
    targetPhone: '+1 (555) 382-9012',
    ...
    sosActive: false,
    sosTimestamp: null,
    currentZoneName: 'Lincoln Elementary School',
    lastLocation: {
      latitude: 6.9147,
      longitude: 79.8732,
      address: 'Lincoln Elementary School, 452 Elm St, Colombo',
  ...
  },
  {
    ...
    type: 'child',
    ownerUid: 'parent_user_default',
    targetUid: 'child_uid_sophia',
    targetName: 'Sophia Anderson',
    targetAge: 14,
    targetPhone: '+1 (555) 721-4490',
    ...
    batteryLevel: 62,
    isOnline: true,
    speed: 'Stationary • Study Hall',
    sosActive: false,
    sosTimestamp: null,
    currentZoneName: 'City Central Library',
    lastLocation: {
      latitude: 6.9030,
      longitude: 79.8580,
      address: 'City Central Library, Colombo 07',
  ...
  child_leo_01: [
    {
      ...
      color: '#2E7D32',
      icon: '🟢',
      description: 'Leo arrived safely inside school boundaries.',
    },
    {
      id: 'hist_2',
      type: 'check_in',
      title: 'Manual Check-in',
      locationName: 'School Cafeteria & Courtyard',
      timestamp: '12:30 PM',
      fullDate: new Date().toISOString(),
      category: 'checkin',
      color: '#1976D2',
      icon: '🔵',
      description: 'Check-in request confirmed. Battery at 88%.',
    },
    {
      id: 'hist_3',
      type: 'battery_info',
      title: 'Battery Status Normal',
      locationName: 'Lincoln Elementary School',
      timestamp: '02:00 PM',
      fullDate: new Date().toISOString(),
      category: 'status',
      color: '#FB8C00',
      icon: '🔋',
      description: 'Device battery level: 85%. Connection strong.',
    },
    {
      id: 'hist_4',
      type: 'safe_zone_exit',
      ...
      color: '#FB8C00',
      icon: '🟡',
      description: 'School hours concluded. On transit to Home.',
    },
    {
      id: 'hist_5',
      type: 'safe_zone_entry',
      ...
      color: '#2E7D32',
      icon: '📍',
      description: 'Arrived at home safely.',
    },
  ],
  child_sophia_02: [
    {
      ...
      color: '#2E7D32',
      icon: '🟢',
      description: 'Sophia checked into Study Hall at Library.',
    },
    {
      id: 'hist_s2',
      type: 'check_in',
      title: 'Study Session Check-in',
      locationName: '2nd Floor Quiet Area',
      timestamp: '04:15 PM',
      fullDate: new Date().toISOString(),
      category: 'checkin',
      color: '#1976D2',
      icon: '🔵',
      description: 'Automated check-in on schedule.',
    },
    {
      id: 'hist_s3',
      type: 'safe_zone_exit',
      title: 'Left Safe Zone (Yesterday)',
      locationName: 'Royal Sports Complex',
      timestamp: '05:45 PM',
      fullDate: new Date(Date.now() - 86400000).toISOString(),
      category: 'zone',
      color: '#FB8C00',
      icon: '🟡',
      description: 'Swimming practice ended.',
    },
  ],
};
...
const INITIAL_MOCK_PETS_ITEMS = [
  {
    ...
    status: 'in_range',
    rssi: -54,
    distanceEstimate: '~3.5m away',
    lastSeen: 'Just now',
    locationAddress: 'Living Room / Garden',
    isRinging: false,
  },
  {
    id: 'tag_item_01',
    type: 'item',
    name: "Leo's School Backpack",
    tagCode: 'GC-BLE-4410',
    avatarEmoji: '🎒',
    batteryLevel: 78,
    status: 'in_range',
    rssi: -68,
    distanceEstimate: '~7.2m away',
    lastSeen: '1 min ago',
    locationAddress: 'With Leo at Lincoln Elementary',
    isRinging: false,
  },
  {
    id: 'tag_item_02',
    ...
    lastSeen: '45m ago',
    locationAddress: 'Hallway Key Hook (Home)',
    isRinging: false,
  },
];
